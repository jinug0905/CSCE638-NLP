...
# -------- Config -------- #
model_path = "./local_models/deepseek-llm-7b-base"  # <-- local path to your DeepSeek model
...
for task in bbh_tasks:
    try:
        ...
        pd.DataFrame(results).to_csv("deepseek_3shot_bbh_results.csv", index=False)
...
# -------- Summary -------- #
print("\n=== 3-Shot BBH Evaluation Summary (DeepSeek-7B-Base, Local) ===")
for r in results:
